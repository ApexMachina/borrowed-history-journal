...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "Borrowed History Journal",
      },
      {
        name: "description",
        content:
          "A quiet place to notice where your knowledge comes from — deduction, direct experience, or borrowed history.",
      },
      { name: "theme-color", content: "#0a0810" },
    ],
    links: [
